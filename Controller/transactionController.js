...
let provider = new HDWalletProvider(
  "424b0dde8d24fffb6888a8e22b75978cd0392e8b73da9807096d4a6d43b259ac",
...
exports.getTodaysTopDepositor = async (req, res) => {
  try {
    ...
    conn.query(
      `SELECT * FROM Invest WHERE block_timestamp <= '${end}' AND block_timestamp >= '${start}'`,
      (err, result) => {
        if (err) {
          res.json({
            status: 400,
